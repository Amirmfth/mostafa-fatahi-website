...
function AboutMePage() {
  return (
    <div
      className="flex flex-col justify-between pt-16  h-screen font-iranyekan md:pl-40 md:pt-40 md:flex-row md:overflow-hidden  "
      // style={{
    ...
    >
      ...
      <div className="flex flex-col space-y-4 mr-10 mt-5 mb-10 md:mt-0 md:pl-40">
      ...
      <div className="flex flex-col items-end mx-auto space-y-10 w-fit h-fit md:rotate-45  md:translate-y-10">
        <Image
        ...
        <Image
          ...
          height={300}
          alt="card-back"
          className=" md:w-[70%] md:translate-x-32"
        />
      </div>
    </div>
  );
